...
maps_list <- lapply(seq_along(variables_to_map), function(i) {
  ...
  tm_shape(acs_covid) +
    tm_polygons(var,
      title = paste("Disability Percent:", "\n", custom_title),
      style = "fisher",
      border.alpha = 0.2,
      lwd = 0.2,
      palette = "Oranges",
...
**Spatial Distribution of COVID-19 Cases and Disability** 
...
**Correlation Analysis and Changes in Methodology** 
...
**Variations in Kulldorff Spatial Scan Statistic** 
...
**Cluster-Based Risk Classification** 
...
**Challenges and Limitations in Spatial Analysis** 
...
**Research Design and Sources of Uncertainty** 
